...
for x in vols:
    for y in temp:
        ...
        df = pd.read_csv('C:\\Users\\biknb\\Downloads\\Cesar\\Phonons_0.5\\'+sys+'\\Phonopy\\'+str(y)+'\\FeV_'+str(x)+'_'+str(y)+'K\\projected_dos.dat', engine='python', sep='        ', skiprows=1, names = ["f", "fe", "v"])
