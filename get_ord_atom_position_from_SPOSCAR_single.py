...
df = pd.read_csv('C:\\Users\\biknb\\Downloads\\Cesar\\Phonons_0.5\\ord\\SPOSCAR', sep=' ', skiprows=8, skipinitialspace=True, header=None, names = ["xx", "yy", "zz"])
...
mult = next((line.split()[1] for i, line in enumerate(open('C:\\Users\\biknb\\Downloads\\Cesar\\Phonons_0.5\\ord\\LAMMPS\\FeV_'+alat+'_'+temp+'\\atoms_positions.data')) if i == 6), None)
...
def merge(atoms_header, sorted_atoms_positions, new_atoms_positions):
    ...
    new_file = open('C:\\Users\\biknb\\Downloads\\Cesar\\Phonons_0.5\\ord\\LAMMPS\\FeV_'+alat+'_'+temp+'\\atoms_positions_ord.data', "w")
...
merge('atoms_header.data', 'sorted_atoms_positions.data', 'atoms_positions_ord.data')
