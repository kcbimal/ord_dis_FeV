# -*- coding: utf-8 -*-
"""
Created on Wed Sep 27 15:01:31 2023
...
def merge(atoms_header, sorted_atoms_positions, new_atoms_positions):
    ...
    new_file = open('C:\\Users\\biknb\\Downloads\\Cesar\\Phonons_0.5\\'+sys+'\\LAMMPS\\FeV_'+alat+'_'+temp+'\\dis_atoms_positions_v2.data', "w")
...
merge('atoms_header.data', 'sorted_atoms_positions.data', 'dis_atoms_positions_v2.data')
